...
notape1206 = TapeDefinition(
    tape_width=8,
    tape_thickness=.2,
    pocket_portrusion=0.8,
    pocket_pitch=4,
    pocket_width=3.5,
    pocket_length=2.1,
    tape_play=-0.0,
...
// Tape for Crystal    
tape12mmX = TapeDefinition(
    tape_width=12,
    tape_thickness=0.3,
    pocket_portrusion=0.9,
    pocket_pitch=4,
    pocket_width=5,
    tape_play=0.1,
    cover_play=0.05,
...
rotate([0, 0, 180]) BlindsFeeder(
    ...
    arrayed_tape_lanes=      [
        ...
        // Our pocket resistor lanes
        LaneDefinition(1, notape1206,   ["R1206","51"]),
        LaneDefinition(1, notape1206,   ["R1206","150"]), 
        LaneDefinition(1, notape1206,   ["R1206","2K"]),   
        LaneDefinition(1, notape1206,   ["R1206","2K2"]),         
        LaneDefinition(1, notape1206,   ["R1206","15K"]),     
        LaneDefinition(1, notape1206,   ["R1206","750K"]),     

        LaneDefinition(1, notape1206,   ["R1206","10K"]),   
        LaneDefinition(1, notape1206,   ["R1206","100K"]),
        
        // Our tape lanes
/*
        LaneDefinition(1, tape1206,   ["R1206-51"]),    
        LaneDefinition(1, tape1206,   ["R1206-750K"]),

        LaneDefinition(1, tape12mmX,   ["X1206-32.7kHz"]), 
        LaneDefinition(1, tapeSOT3,   ["SOT23-BAT54S"]), 
*/
...
//        LaneDefinition(1, tape1206,   ["1206-tape"]),       
